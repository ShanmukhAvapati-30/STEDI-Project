...
accelerometersource_node1779706771590 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_trusted", transformation_ctx="accelerometersource_node1779706771590")
...
Join_node1779707548749 = Join.apply(frame1=customersource_node1779706801171, frame2=accelerometersource_node1779706771590, keys1=["email"], keys2=["user"], transformation_ctx="Join_node1779707548749")

# Script generated for node Select Fields
SelectFields_node1779707548750 = SelectFields.apply(
    frame=Join_node1779707548749,
    paths=[
        "customername",
        "email",
        "phone",
...
AmazonS3_node1779707032195.writeFrame(SelectFields_node1779707548750)
job.commit()