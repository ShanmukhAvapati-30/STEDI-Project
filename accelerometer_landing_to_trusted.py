...
customersource_node1779703929660 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="customer_trusted", transformation_ctx="customersource_node1779703929660")
...
SelectFields_node1779703975705 = SelectFields.apply(
    frame=Join_node1779703975704,
    paths=[
        "user",
        "timestamp",
        "x",
...
AmazonS3_node1779704024411.writeFrame(SelectFields_node1779703975705)
job.commit()